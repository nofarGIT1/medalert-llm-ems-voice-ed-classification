# MedAlert: ED Decision Classification from LLM-Generated EMS Voice Reports
...
The clean dataset contains the generated reports after LLM-based post-processing:
...
The noisy dataset contains the ASR transcripts:
...
A noisy audio sample generated by the audio pipeline is available below:
